...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/subprocess-tee-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11665&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/subprocess-tee-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `subprocess-tee` can be installed with:

```
conda install subprocess-tee
```

It is possible to list all of the versions of `subprocess-tee` available on your platform with:
